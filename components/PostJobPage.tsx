                ...
                <div className="space-y-5 md:space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-transparent border border-zinc-800 rounded-xl text-[15px] text-white placeholder:text-zinc-500 focus:outline-none focus:border-zinc-700 transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-3 bg-transparent border border-zinc-800 rounded-xl text-[15px] text-white placeholder:text-zinc-500 focus:outline-none focus:border-zinc-700 transition-colors resize-none"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-3 bg-transparent border border-zinc-800 rounded-xl text-[15px] text-white focus:outline-none focus:border-zinc-700 transition-colors appearance-none cursor-pointer"
                      >
