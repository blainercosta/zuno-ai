...
export default function CheckoutSuccessPage() {
  ...
  // DEV: skip tela inicial e ir direto pro onboarding
  const [step, setStep] = useState(import.meta.env.DEV ? 1 : 0);
  ...
  const isStepValid = () => {
    switch (step) {
      ...
      case 5: {
        // Se "Outro" selecionado, valida o campo customizado
        if (showCustomNiche) {
  ...
  if (step === 0) {
    return (
      <div className="min-h-screen bg-[#09090b] text-white flex flex-col items-center justify-center px-6 py-12 relative overflow-hidden">
          {/* Confetti */}
          {showConfetti && (
              ...
              {[...Array(20)].map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: ['#7349D4', '#FF7BCA', '#FFF96F', '#62D4DD'][Math.floor(Math.random() * 4)],
                  }}
                />
              ))}
            </div>
          ...
          <div className="max-w-md w-full text-center relative z-10">
            ...
            <button
              onClick={handleNext}
              className="w-full bg-white text-zinc-950 font-medium py-4 rounded-xl hover:bg-zinc-100 transition-colors"
            >
      ...
      <div className="min-h-screen bg-[#09090b] text-white flex flex-col items-center justify-center px-6 py-12">
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-medium mb-3 tracking-tight">Tudo pronto, {formData.nome}!</h1>
            <p className="text-zinc-400 text-base">
              Manda um oi pra nossa IA e salva o contato
            </p>
          </div>
          ...
          <div className="space-y-3 mb-8">
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-zinc-900/50 border border-zinc-800/50">
              ...
              <p className="text-sm text-zinc-300">Alertas antes de virar trend</p>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-xl bg-zinc-900/50 border border-zinc-800/50">
              ...
              <p className="text-sm text-zinc-300">Curadoria personalizada pro seu nicho</p>
            </div>
          </div>
          ...
          <p className="text-center text-xs text-zinc-600 mt-4">
            Salve o contato para não perder as notícias
          </p>
        </div>
        ...
        <div className="max-w-md w-full">
          ...
          {step === 2 && (
            <div className="animate-fadeIn">
              ...
              <p className="text-zinc-500 text-base mb-8">
                Para enviar seu acesso e novidades importantes
              </p>
              <input
                type="email"
          ...
          {step === 4 && (
            <div className="animate-fadeIn">
              ...
              <p className="text-zinc-500 text-base mb-8">
                Onde você vai receber as notícias em primeira mão
              </p>
              <input
                type="tel"
                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl border text-sm text-left transition-all ${
                      formData.nicho === nicho && !showCustomNiche
                        ? 'bg-[#7349D4]/10 border-[#7349D4] text-white'
                  ...
                  <input
                    ...
                    className={`w-full p-4 rounded-xl border text-sm text-left transition-all ${
                      showCustomNiche && formData.nichoCustom
                        ? 'bg-[#7349D4]/10 border-[#7349D4] text-white placeholder:text-zinc-500'
                        : 'bg-black/40 border-zinc-800 text-zinc-400 placeholder:text-zinc-600 hover:border-zinc-700'
                    } focus:outline-none focus:border-[#7349D4]`}
                  />
                  {errors.nichoCustom && (
