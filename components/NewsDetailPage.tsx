  ...
  return (
    <div className="min-h-screen bg-zinc-950 overflow-x-hidden">
      ...
      <div className="max-w-[720px] mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-12">
        ...
        {/* Resumo em 1 minuto */}
        {news.key_takeaway && (
          <div className="mb-8 md:mb-12 rounded-xl bg-zinc-900/60 border border-zinc-800 p-4 md:p-6">
            ...
            <p className="mt-3 text-xs text-zinc-500">
              Resumo gerado automaticamente a partir da fonte original.
            </p>
          </div>
        )}
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              >
                <svg className="size-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <path d="M12.001 2.003c-5.514 0-9.997 4.483-9.997 9.997 0 1.762.462 3.483 1.34 5.001L2.05 21.951a.75.75 0 0 0 .921.921l4.951-1.293a9.96 9.96 0 0 0 4.079.87h.004c5.514 0 9.997-4.483 9.997-9.997s-4.483-9.997-9.997-9.997zm0 18.243h-.003a8.24 8.24 0 0 1-4.198-1.149l-.301-.179-3.117.814.833-3.04-.196-.312a8.238 8.238 0 0 1-1.263-4.383c0-4.552 3.702-8.253 8.249-8.253 2.203 0 4.274.859 5.833 2.419a8.196 8.196 0 0 1 2.415 5.838c0 4.552-3.701 8.254-8.252 8.254z"/>
                </svg>
              </button>
