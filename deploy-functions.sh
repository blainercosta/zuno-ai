...
echo ""
echo "Deploying phantombuster..."
npx supabase functions deploy phantombuster --project-ref "$SUPABASE_PROJECT_REF"
...
echo "Secrets para phantombuster (docs/PHANTOMBUSTER_INGESTION.md):"
echo "  npx supabase secrets set PHANTOMBUSTER_API_KEY=... PHANTOMBUSTER_AGENT_ID=... PHANTOMBUSTER_WEBHOOK_SECRET=... --project-ref $SUPABASE_PROJECT_REF"
